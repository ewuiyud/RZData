...
namespace RZData
{
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            AddButton(panel, "属性载入", "从Excel文件导入族实例属性", "读取Excel文件中的族属性配置，并为对应的族添加实例属性。支持合并单元格格式的Excel文件。"
                , "RZData.Commands.RevitImportExcelPropertiesCommand", "Resources/template_load.png");
